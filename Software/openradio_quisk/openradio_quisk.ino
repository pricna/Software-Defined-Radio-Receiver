...
#define RX_FREQ 14100000
#define TX_FREQ 14100000
...
static void set_rx_freq(uint32_t freq)
{
  ...
  unsigned long long new_freq = freq * 100;
  uint_fast8_t mult;
...
//  Serial.print(new_freq); 
  ...
  // mult of 50 only works for this frequency, needs to be changed for other frequencies
  mult = 50;
    
  pll_freq = mult*new_freq;
  
  si5351.set_freq_manual(new_freq, pll_freq, SI5351_CLK1);
  si5351.set_freq_manual(new_freq, pll_freq, SI5351_CLK2);
